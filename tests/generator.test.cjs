...
const {Generator,combinations} = require('../core/generator.cjs');
...
test('bundled PDF is byte-identical to the agreed source',()=>{
  ...
  assert.equal(hash('resources/MMEL.pdf'),hash('sources_mel_mmel/00_current_mmel/FAA_A320_MMEL_Rev32_2025-07-30.pdf'));
});
