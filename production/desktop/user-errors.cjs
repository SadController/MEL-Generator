...
const CATALOG=Object.freeze({
  ...
  UPDATE_VERIFICATION_FAILED:{title:'The update could not be verified',message:'The downloaded installer did not pass the required integrity check.',action:'Keep the installed version. Do not run the downloaded file manually.',severity:'error',retryable:true},
