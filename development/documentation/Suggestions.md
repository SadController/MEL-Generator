...
3. Prepare briefing creates a new random set and opens Failures. Each tap performs a new selection without repeating the combinations until the current sized pool is exhausted. The order of rejection does not change the identity of the set.
